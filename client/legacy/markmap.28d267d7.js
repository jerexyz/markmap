...
var loader = createCommonjsModule(function (module, exports) {
  ...
  function _loadJS() {
    _loadJS = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(items, options) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 5:
              ...
              item = _step2.value;
              _context.next = 9;
              return loadJSItem(item, options);
  ...
  function persistJS(items, context) {
    return items.map(function (item) {
      ...
      if (item.type === 'iife') {
        ...
        return (0, html$1.wrapHtml)('script', (0, html$1.escapeScript)(buildCode.apply(void 0, [fn].concat(_toConsumableArray((getParams == null ? void 0 : getParams(context)) || [])))));
      }
    });
  }
...
var mathjax = createCommonjsModule(function (module, exports) {
  ...
  var scripts = [{
    ...
    data: {
      ...
      getParams: function getParams(context) {
        return [Object.assign({}, context.mathJax)];
      }
    }
  }, {
    type: 'script',
...
var view = createCommonjsModule(function (module, exports) {
  ...
  function _loadPlugins() {
    _loadPlugins = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(items, options) {
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              items = items.map(function (item) {
                if (typeof item === 'string') {
                  ...
                  if (!item) {
                    console.warn("[markmap] Unknown plugin: ".concat(name));
                  }
                }
      ...
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        if (child.type === 'text') {
          ...
          if (type === 'link') {
            ...
            style = Object.assign(Object.assign({}, style), {}, _defineProperty({}, type, true));
          }
        } else if (child.type.endsWith('_close')) {
          var _type = child.type.slice(0, -6);
      ...
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        ...
        if (token.type.endsWith('_open')) {
          ...
          current.c.push({
            t: token.type,
            d: depth + 1,
            v: "<pre><code class=\"language-".concat(token.params, "\">").concat((0, util.escapeHtml)(token.content), "</code></pre>"),
            c: []
          });
...
/* src/components/markmap.svelte generated by Svelte v3.25.1 */
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(svg, file, 78, 0, 1665);
		},
